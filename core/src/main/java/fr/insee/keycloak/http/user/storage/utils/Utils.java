...
public class Utils {
  ...
  public static SimpleHttp prepareRequest(
      HttpClient client,
      String method,
      String baseUrl,
      String path,
    ...
    System.out.println(baseUrl + Utils.inject(path, params));
  ...
  private static SimpleHttp addHeaderAndBody(
      Map<String, String> headers,
      String bodyType,
      List<String> body,
      Map<String, String> params,
    ...
    switch (bodyType) {
      ...
      case "application/x-www-form-urlencoded":
        ...
        Map<String, String> bodyParams =
            body.stream().collect(Collectors.toMap(s -> s.split("=")[0], s -> s.split("=")[1]));
  ...
  /**
   * Inject the params in the expression by replacing ${var} by the value of the key var contained
   * in the Params Map
   *
   * @param expr
   * @param params
