...
public class HttpUserModelAdapter extends AbstractUserAdapterFederatedStorage {
  ...
  public boolean equals(Object obj) {
    ...
    if (httpUser == null) {
      if (other.httpUser != null) return false;
    } else if (!httpUser.equals(other.httpUser)) return false;
    return true;
  }
  ...
  public String getFirstAttribute(String name) {
    ...
    List<String> values = httpUser.getAttributes().get(name);
    if (values != null) {
      return values.get(0);
    }
    return null;
